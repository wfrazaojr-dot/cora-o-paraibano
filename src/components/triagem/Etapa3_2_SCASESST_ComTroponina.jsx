          ...
          <div className="mt-6 pt-6 border-t border-teal-300">
            ...
            <div className="space-y-3 bg-white p-4 rounded border border-teal-200">
              <div className="space-y-1 pb-3 border-b border-gray-200">
                <Label className="font-semibold text-sm">LSN - Limite Superior da Normalidade (percentil 99) do Laboratório *</Label>
                <p className="text-xs text-gray-500">Ex: 0.04, 0.03, etc.</p>
                <Input
                  type="number"
                  step="0.001"
