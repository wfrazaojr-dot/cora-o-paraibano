            ...
            <Card className="mb-4 border-2 border-orange-200">
              ...
              <CollapsibleContent>
                <CardContent className="pt-4 space-y-4">
                  ...
                  {/* HEART SCORE - dentro do Bloco 2 */}
                  <div className="border-t-2 border-purple-300 pt-4 mt-4 space-y-4">
                    <h4 className="font-bold text-purple-900 text-lg">🧮 HEART SCORE</h4>
