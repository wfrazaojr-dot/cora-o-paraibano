              ...
              <div className="space-y-4 text-sm text-gray-700">
                ...
                <div className="bg-red-50 p-4 rounded border border-red-200 mt-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li><strong>Bloqueio de Ramo Esquerdo (BRE):</strong> Presente em ~7% dos pacientes com infarto agudo. BRE novo é equivalente a SCACST. Para BRE prévio, usar critérios de Sgarbossa ou Barcelona.</li>
                    <li><strong>Portadores de Marcapasso:</strong> Considerar supra desnivelamento de ST diagnóstico de IAM somente quando &gt; 5mm.</li>
                    <li><strong>Principais derivações:</strong> Anteriores (V1-V6), Inferiores (DII, DIII, aVF), Laterais (DI, aVL)</li>
                    <li><strong>Derivações atípicas:</strong> V3R e V4R (parede livre do VD), V7-V9 (parede posterior)</li>
                  </ul>
                </div>
              </div>
            </CardContent>
